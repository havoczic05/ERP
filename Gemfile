...
# Spreadsheet parsing (CSV + XLSX) for the import subsystem — pure Ruby, no native extensions
gem "roo"
...
group :development, :test do
  ...
  # Inspect generated PDF text/content in specs [https://github.com/prawnpdf/pdf-inspector]
...
group :test do
  ...
  # Retry inherently-flaky browser specs (transient Selenium/chromedriver glitches
  # such as lost clicks/keystrokes under CI load) [https://github.com/NoRedInk/rspec-retry]
  gem "rspec-retry"
